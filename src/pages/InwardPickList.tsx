...
import { fetchInwardPickLists, setAssigning } from "@/app/store/picklistSlice";
...
const InwardPickList = () => {
  ...
  const fetchPicklists = () => {
    dispatch(
      fetchInwardPickLists({ page, size: PAGE_SIZE, search: debouncedSearch }),
    );
  };

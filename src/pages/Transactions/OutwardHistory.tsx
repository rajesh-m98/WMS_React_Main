...
export const OutwardHistory = () => {
  ...
  const {
    ...
    loading,
    totalCount,
  } = useAppSelector((state) => state.putaway.outward);
  ...
  useEffect(() => {
    dispatch(handleFetchPutawayHistory("outward", { page, size: pageSize }));
  }, [dispatch, page]);

  const handleViewDetail = (id: number) => {
    navigate(`/transactions/tasks/${id}?type=putaway&reqType=outward`);
  };
